...
class MangaTest {
    ...
    @BeforeEach
    public void setUp(){
        manga1 = new Manga("Kimetsu", 24);
        manga2 = new Manga("Kimetsu", 24);
    }

    @Test
    public void accessors_ReturnData_WhenInitialized(){
        Assertions.assertEquals("Kimetsu", manga1.name());
    ...
    @Test
    public void constructor_ThrowNullPointerException_WhenObjectsIsNull(){
