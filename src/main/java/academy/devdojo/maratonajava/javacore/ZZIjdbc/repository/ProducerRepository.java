...
public class ProducerRepository {
    ...
    private static void preparedStatementSaveTransaction(Connection conn, List<Producer> producers) throws SQLException {
        ...
        for (Producer p : producers) {
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                ...
                if (p.getName().equals("White Fox")) throw new SQLException("Cant save White Fox");
                ps.execute();
            } catch (SQLException e){
                e.printStackTrace();
                shouldRollBack = true;
    ...
    public static void updatePreparedStatement(Producer producer) {
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.info("Updated producer '{}' with prepared statement, rows affected '{}'", producer.getId(), rowsAffected);

        } catch (SQLException e) {
            log.error("Error while trying update producer '{}' with prepared statement", producer.getId(), e);
            e.printStackTrace();
        }
    }
    ...
    public static List<Producer> findByNamePreparedStatement(String name) {
        log.info("Finding Producers by name with prepared statement");
        List<Producer> producers = new ArrayList<>();
        try (Connection conn = ConnectionFactory.getConnection();
    ...
    public static List<Producer> findByNameCallableStatement(String name) {
        log.info("Finding by name callable statement");
        List<Producer> producers = new ArrayList<>();
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find producer by name with callable statement", e);
            e.printStackTrace();
        }
        return producers;
    }
    ...
    public static void showProducerMetaData() {
        log.info("Showhing Producer Metadata");
    ...
    public static void showDriverMetaData() {
        log.info("Showhing Driver Metadata");
        String sql = "SELECT * FROM anime_store.producer;";
        try (Connection conn = ConnectionFactory.getConnection()) {
...
//                rs.cancelRowUpdates();
    ...
    public static List<Producer> findByNameAndInsertWhenNotFound(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find producer by name and insert when not found", e);
            e.printStackTrace();
        }
        return producers;
    }
    ...
    public static void findByNameAndDelete(String name) {
        log.info("Finding Producers by name and deleting");
        String sql = "SELECT * FROM anime_store.producer where name like '%%%s%%';"
                .formatted(name);
        try (Connection conn = ConnectionFactory.getConnection();
             Statement stmt = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            ...
            log.error("Error while trying to find producer by name and deleting", e);
            e.printStackTrace();
        }
    }
