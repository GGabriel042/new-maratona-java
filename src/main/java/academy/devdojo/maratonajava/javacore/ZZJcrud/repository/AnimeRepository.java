...
public class AnimeRepository {
    public static List<Anime> findByName(String name) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find anime by name with prepared statement", e);
            e.printStackTrace();
        }
        return animes;
    }
    ...
    public static Optional<Anime> findById(Integer id) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to find anime by id with prepared statement", e);
        }
    ...
    public static void save(Anime anime) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying save anime '{}'", anime.getId(), e);
            e.printStackTrace();
        }
    }
    ...
    public static void update(Anime anime) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying update anime '{}'", anime.getId(), e);
        }
    }
